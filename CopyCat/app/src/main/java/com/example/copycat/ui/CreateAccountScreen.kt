...
@Composable
fun CreateAccountLayout(modifier: Modifier = Modifier, navController: NavController, copyCatViewModel: CopyCatViewModel) {
    ...
    Column(
        ...
        Button( onClick = { copyCatViewModel.createAccount(emailInput,passwordInput)},
